  ...
  wt: {
    ...
    f11: {
      ...
      tickets: {
        ...
        desc: 'Create support tickets with categories (Bug, Feature Request, General). Priority levels from Low to Critical. Each ticket has a linked chat thread for direct communication with staff.',
      },
    },
    f12: {
      label: 'Point of Sale',
    ...
    f13: {
      ...
      s1: {
        ...
        b3: 'Staff and company-level dashboards',
      },
      s2: {
        tag: 'Charts',
      ...
      s3: {
        ...
        desc: 'Generate detailed sales reports filtered by date range, company, or product. Export to CSV or XLSX for accounting and external analysis.',
        b1: 'Filterable by date, company, and product',
        b2: 'CSV and XLSX export formats',
        b3: 'Staff-level platform-wide reports',
      },
    },
    f14: {
      label: 'Customer Support',
      title: 'Tickets & Issue Tracking',
      desc: 'A built-in support ticket system with categories, priorities, and integrated chat — resolve customer issues without leaving Dukkan.',
      s1: {
        tag: 'Create',
        title: 'Submit a Ticket',
        desc: 'Customers create tickets from their portal — choose a category (Bug, Feature Request, General Support) and priority level (Low, Normal, High, Critical). Describe the issue with text and attachments.',
      ...
      s2: {
        ...
        desc: 'Each ticket progresses through stages: Open → In Progress → Pending Customer → Resolved → Closed. A linked chat thread lets customers and staff discuss the issue in real-time.',
        b1: '5-stage status workflow',
        b2: 'Integrated chat thread per ticket',
        b3: 'Staff assignment and reassignment',
      },
      s3: {
        tag: 'Manage',
        title: 'Staff Ticket Dashboard',
        desc: 'Staff see all tickets across the platform with filters by status, priority, and category. Assign tickets to team members, add internal notes, and resolve issues efficiently.',
        b1: 'Platform-wide ticket overview',
        b2: 'Filter by status, priority, and category',
        b3: 'Assign to specific staff members',
      },
    },
    f15: {
      label: 'Promotions',
